...
namespace BethanysPieShopHRM.Api.Migrations
{
    ...
    [Migration("20210511191706_EmployImage2add")]
    partial class EmployImage2add
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GSBlazor.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("GSBlazor.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("GSBlazor.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GSBlazor.Shared.Employee", b =>
                {
                    b.HasOne("GSBlazor.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GSBlazor.Shared.JobCategory", "JobCategory")
                        .WithMany()
